...
//            int count = 0;
//            for (auto c : word) {
//                if (a->next[c - 'a'] == nullptr) return count;
//                else count++;
//                a = a->next[c - 'a'];
//            }
//            return count;
...
//        if (words[words.size() - 1] == "") {
//            vector<string> ans;
//            int m = words.size();
//            if (m == 1) return ans;
//            sort(words.begin(), words.end(), cmp);
//            while (words[0].size() < 1) words.erase(words.begin());
//            minSize = words[0].size();
//            Trie t;
//            for (string s : words) {
//                string copy = s;
//                if (s.size() < minSize * 2) t.insert(s);
//                else {
//                    unsigned int count = t.search(s);
...
//
//    bool check(string a) {
//        if (exist.count(a)) return true;
//        else {
//            for (int i = minSize; i <= a.size() - minSize; i++) {
//                if (exist.count(a.substr(0, i)) && check(a.substr(i))) return true;
//            }
//            return false;
//        }
//    }
